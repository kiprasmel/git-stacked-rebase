...
import { setupHookWrapper, setupPostRewriteHookFor } from "./postRewrite";
...
export const gitStackedRebase = async (
	...
	try {
		...
		setupHookWrapper("post-rewrite", dotGitDirPath);
		setupPostRewriteHookFor("git-stacked-rebase", dotGitDirPath);
