...
export async function setupRepo({
	...
	const latestStackedBranchRef: Git.Reference = await Git.Branch.create(
		repo,
		"stack-latest",
	...
	execSyncInRepo(`${defaultGitCmd} checkout -b ${latestStackedBranchRef.name()}`);
